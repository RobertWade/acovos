    ...
    <main class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="max-w-xl mx-auto py-16 sm:py-24">
        <div class="text-center">
          ...
          >Die Seite existiert nicht.</h1>
          <p
            class="mt-2 text-lg text-gray-500"
          >Die Seite die du suchst konnte leider nicht gefunden werden.</p>
        </div>
        <div class="mt-12">
          <h2 class="text-sm font-semibold text-gray-500 tracking-wide uppercase">Beliebte Seite</h2>
          ...
          <div class="mt-8">
            <div
              @click="$router.back()"
              class="cursor-pointer text-base font-medium text-indigo-600 hover:text-indigo-500"
            >
              Oder zurück wo du her kamst
...
import { LoginIcon, RssIcon, SupportIcon, HomeIcon } from '@heroicons/vue/outline'

const links = [
  { title: 'Homepage', description: 'Erfahre mehr über unseren Service', icon: HomeIcon },
  { title: 'Login', description: 'Loge dich in dein persönliches Dashboard ein', icon: LoginIcon },
  { title: 'Support', description: 'Nimm Kontakt mit unserem Kundensupport auf', icon: SupportIcon },
  { title: 'Blog', description: 'Lese unsere aktuellen Aritkel', icon: RssIcon },
]
const social = [
  {
    name: 'Facebook',
