...
<template>
  <div class="w-full my-8 container mx-auto max-w-7xl p-8">
    <div class="flex items-end justify-end">
      <div class="text-primary flex gap-2 justify-center">
        <div @click="$router.push('/')" class="cursor-pointer font-medium">
          Zurück zum Website
        </div>
      </div>
    </div>
    <div class="">
      <div class="mt-4">
        <h1 class="text-4xl mb-4">Datenschutz</h1>
        ...
        IONOS: https://www.ionos.de/terms-gtc/terms-privacy. <br />
        ...
        ist: Constanze Dima <br />
        Telefon: +49 160 96817397 E-Mail: constanze.dima@hotmail.de <br />
        ...
        <b
          ...
          gegen Direktwerbung (Art. 21 DSGVO)</b
        >
        <br />
        ...
        an dem Schloss-Symbol in Ihrer Browserzeile. <br />
        ...
        Daten können Sie sich jederzeit an uns wenden. <br />
        <br />
        <b>
          <br />
